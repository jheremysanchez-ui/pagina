...
import { get_products, get_filtered_products } from '../redux/accions/products'
  ...
  return (
    <Layout>
      <div className="bg-white">
        <div>
          {/* Filtros para pantallas mobiles */}
              ...
              >
                <div className="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
                  ...
                  <form onSubmit={e => onSubmit(e)} className="mt-4 border-t border-gray-200">
                            ...
                            <Disclosure.Panel className="pt-6">
                              <div className="space-y-6">
                                <div className='form-group '>
                                  ...
                                  <select
                                    className='my-2 font-sofiapro-light inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 
                                    bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500'
                                    id='sortBy'
                                    name='sortBy'
                                    onChange={e => onChange(e)}
                                    value={sortBy}
                    ...
                    <button
                      type="submit"
                      className="float-right inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm 
            ...
            <section aria-labelledby="products-heading" className="pt-6 pb-24">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                ...
                <form onSubmit={e=>onSubmit(e)} className="hidden lg:block">
                  ...
                  <button
                    type="submit"
                    className="float-right inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 
                    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    Buscar
                  </button>
                </form>
                {/* Cuadricula de producctos */}
...
const mapStateToProps = state => ({
    ...
    filtered_products: state.root.Products.filtered_products
})
