...
const Cart = ({
  ...
  tax = 0.15
  estimated_tax = (compare_amount * tax)
                  ...
                  <dt className="flex items-center text-sm text-gray-600">
                    ...
                    <a href="/" className="ml-2 flex-shrink-0 text-gray-400 hover:text-gray-500">
                      <span className="sr-only">
                        Obtenga más información sobre cómo se calcula el envío
                      </span>
...
const mapStateToProps = state => ({
    ...
    wishlist_items: state.root.Wishlist.items,
    amount: state.root.Cart.amount,
    compare_amount: state.root.Cart.compare_amount,
